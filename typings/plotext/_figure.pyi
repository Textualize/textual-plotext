...
class _figure_class:
    ...
    def xaxes(self, lower: bool | None = None, upper: bool | None = None) -> None: ...
    def yaxes(self, left: bool | None = None, right: bool | None = None) -> None: ...
    def frame(self, frame: bool | None = None) -> None: ...
